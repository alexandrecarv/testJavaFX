...
public class ViewController implements Initializable {
	...
	public void onBtAll() {
		for (Person person : comboBoxPerson.getItems()) {
			...
			labelSelectAll.setText(person.getName());
		}
	}
	@FXML
	public void onBtSave() {
		Person person = comboBoxPerson.getSelectionModel().getSelectedItem();
		labelSelect1.setText(person.getName());
		
		if (labelSelect1 != null) {
			labelSelect2.setText(person.getName());
		}
	...
	private void initializeContraints() {
